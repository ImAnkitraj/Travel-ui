                      ...
                      child: Container(
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              Text('${destination.activities.length} activities', style:TextStyle(letterSpacing: 1.2,fontSize: 22.0, fontWeight: FontWeight.w600)),
                    ...
                    Container(
                      ...
                      child: Stack(children: <Widget>[
                        Hero(
                          ...
                          child:ClipRRect(
                            borderRadius: BorderRadius.circular(20.0),
                            child: Image(height: 180.0, width: 180.0, image: AssetImage(destination.imageUrl),fit: BoxFit.cover, )
                          ), 
                        ),
                        Positioned(
                          left: 10.0,
