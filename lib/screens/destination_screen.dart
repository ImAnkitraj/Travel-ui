        ...
        Stack(children: <Widget>[
          Container(
            ...
            child: Hero(
              ...
              child: ClipRRect(
                child: Image(image: AssetImage(widget.destination.imageUrl),fit: BoxFit.cover,),
                borderRadius: BorderRadius.circular(30.0),
              ),
            ),
          ),
          Padding(
            ...
            child: Row(
              ...
              children: <Widget>[
              IconButton(icon: Icon(Icons.arrow_back), onPressed: (){Navigator.pop(context);},iconSize: 30.0, color: Colors.black,),
              Row(children: <Widget>[
                IconButton(icon: Icon(Icons.search), onPressed: (){Navigator.pop(context);},iconSize: 30.0, color: Colors.black,),
                IconButton(icon: Icon(FontAwesomeIcons.sortAmountDown), onPressed: (){Navigator.pop(context);},iconSize: 25.0, color: Colors.black,),
              ],)
            ],),
          ),
          Positioned(
            ...
            child: Column(
              ...
              children: <Widget>[
                Text(widget.destination.city, style: TextStyle(color: Colors.white, fontWeight: FontWeight.w600, fontSize: 35.0, letterSpacing: 1.2),),
                Row(
                  children: <Widget>[
                    Icon(FontAwesomeIcons.locationArrow, size: 15.0, color: Colors.white70,),
                    SizedBox(width: 5.0,),
                    Text(widget.destination.country, style: TextStyle(fontSize: 20.0,color: Colors.white70,)),
                  ],
                ),
              ],
            ),
              ...
              return Stack(children: <Widget>[
                  ...
                  child: Padding(
                    ...
                    child :Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center,children: <Widget>[
                      Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,crossAxisAlignment: CrossAxisAlignment.start,children: <Widget>[
                        Container(
                          width: 120.0,
                          child: Text(activity.name,maxLines: 2,overflow: TextOverflow.ellipsis, style: TextStyle(fontSize: 18.0, fontWeight: FontWeight.w600),),
                        ),
                ...
                Positioned(
                  ...
                  child: ClipRRect(
                    ...
                    child: Image(image : AssetImage(activity.imageUrl), width:110,fit:BoxFit.cover),
                  ) ,
                ),
              ],);
            },
